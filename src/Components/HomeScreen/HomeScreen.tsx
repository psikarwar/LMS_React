  ...
  return (
    <>
      ...
      <div className="px-4 sm:px-6 lg:px-8">
        ...
        {/* Title for Top Courses */}
        <h2 className="font-inter font-semibold text-2xl md:text-3xl leading-[150%] text-gray-900 mt-8 sm:mt-10 md:mt-12 lg:mt-14">
          Top Courses
        </h2>
        ...
        {/* Popular Mentor Section */}
        <h2 className="font-inter font-semibold text-2xl md:text-3xl leading-[150%] text-gray-900 mt-12">
          Top Instructors
        </h2>
        <div className="mt-6">
          <PopularMentor mentors={mentors} />
