...
// MessageCard component
const MessageCard: React.FC<Message> = ({ userName, userImage, date, messageContent }) => (
  <div className="mt-4 p-4 sm:p-6 border border-gray-200 rounded-lg bg-white shadow-md hover:shadow-lg transition-shadow duration-300">
    {/* User Info */}
    <div className="flex items-center gap-3 sm:gap-4 mb-2">
      <img
        src={userImage}
    ...
    {/* Message Content */}
    <p className="text-sm sm:text-base text-gray-800 leading-relaxed">{messageContent}</p>
  </div>
);
