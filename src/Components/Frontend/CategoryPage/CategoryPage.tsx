...
import { icondown, iconfilterimg, rect1136img, rect1080img, paginationleft, iconchright } from '../../images';
          ...
          <div className="w-full md:w-3/4">
            ...
            <div className="flex justify-center items-center gap-2 mt-10">
              <button className="bg-white border border-gray-200 rounded-lg p-3 cursor-pointer">
                <img src={paginationleft} alt="Left Chevron" />
              </button>
              ...
              <button className="bg-white border border-gray-200 rounded-lg p-3 cursor-pointer">
                <img src={iconchright} alt="Right Chevron" />
              </button>
            </div>
          </div>
        </div>
