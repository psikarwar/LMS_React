  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 text-gray-900">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 space-y-4 sm:space-y-0">
        <h1 className="text-lg sm:text-2xl font-semibold">Courses</h1>
        <NavLink to="/admin/Courses">
          <button className="bg-blue-600 text-white py-2 px-4 sm:px-6 rounded-lg font-medium w-full sm:w-auto">
            Add Course
          </button>
        </NavLink>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {coursesData.map((course) => (
          ...
          >
            ...
            {/* Course Title */}
            <h2 className="text-lg sm:text-xl font-semibold mb-4">{course.title}</h2>
            <hr className="mb-4" />
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between">
                <div className="text-center">
                  <strong className="text-md sm:text-lg">{course.price}</strong>
                  <p className="text-xs sm:text-sm text-gray-600">Price</p>
                </div>
                <div className="text-center">
                  <strong className="text-md sm:text-lg">{course.certificates}</strong>
              ...
              <div className="flex justify-between">
                <div className="text-center">
                  <strong className="text-md sm:text-lg">{course.chapters}</strong>
                  <p className="text-xs sm:text-sm text-gray-600">Chapters</p>
                </div>
                <div className="text-center">
                  <strong className="text-md sm:text-lg">{course.reviews}</strong>
              ...
              <div className="flex justify-between">
                <div className="text-center">
                  <strong className="text-md sm:text-lg">{course.orders}</strong>
                  <p className="text-xs sm:text-sm text-gray-600">Orders</p>
                </div>
                <div className="text-center">
                  <strong className="text-md sm:text-lg">{course.addedToShelf}</strong>
                  <p className="text-xs sm:text-sm text-gray-600">Added to Shelf</p>
                </div>
              </div>
            </div>
          </div>
